...
let g:colors_name="skittles_dark_cw"
...
hi SpecialKey guifg=#F8F8F2 ctermfg=248 guibg=#231F20 ctermbg=234
...
hi clear SpellBad
hi SpellBad ctermfg=red guisp=#FF0000 cterm=underline gui=undercurl
hi clear SpellCap
hi SpellCap ctermfg=blue guisp=#7070F0 cterm=underline gui=undercurl
hi SpellLocal guisp=#70F0F0 gui=undercurl
hi SpellRare guisp=#FFFFFF gui=undercurl

hi Statement guifg=#C01414 ctermfg=1 gui=none
hi StatusLine guifg=#455000 ctermfg=61 guibg=fg
hi StatusLineNC guifg=#808080 ctermfg=244 guibg=#080808 ctermbg=0
hi TabLineFill term=bold cterm=bold ctermbg=0
hi TabLineSel ctermfg=61 ctermbg=0
hi TabLine ctermfg=61 ctermbg=0
...
hi TrailingWhitespace ctermbg=144 guibg=#404040
